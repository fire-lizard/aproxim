...
double Approximator_2::GetParameter(const QVector<QVector3D> &data, const string &operation)
{
    double result = 0;
...
double Approximator_2::GetA(const QVector<QVector3D> &data)
{
	const double sx1 = GetParameter(data, "AV_X1");
	const double sx2 = GetParameter(data, "AV_X2");
	const double sy = GetParameter(data, "AV_Y");
...
double Approximator_2::GetB(const QVector<QVector3D> &data)
{
...
double Approximator_2::GetB2(const QVector<QVector3D> &data)
{
	const double sx1x2 = GetParameter(data, "SUM_X1X2");
	const double sx1y = GetParameter(data, "SUM_X1Y");
	const double sx2y = GetParameter(data, "SUM_X2Y");
...
double Approximator_2::Delta(const QVector<QVector3D> &data1, const QVector<QVector3D> &data2)
{
    double result = 0;
...
double Approximator_2::Sigma(const QVector<QVector3D> &data)
{
    double result = 0;
	const int n = data.size();
...
double Approximator_2::Correlation(const QVector<QVector3D> &data)
{
